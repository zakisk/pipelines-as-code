...
`
	...
	allEnvVars := []string{
		...
		"TEST_GITHUB_GHE_API_URL", "TEST_GITHUB_GHE_TOKEN",
		"TEST_GITHUB_GHE_EL_URL", "TEST_GITHUB_GHE_REPO_OWNER_GITHUBAPP",
		...
		"TEST_BITBUCKET_DATA_CENTER_API_URL", "TEST_BITBUCKET_DATA_CENTER_USER",
		"TEST_BITBUCKET_DATA_CENTER_TOKEN", "TEST_BITBUCKET_DATA_CENTER_E2E_REPOSITORY",
	...
	expected := map[string]string{
		...
		"TEST_GITHUB_GHE_API_URL":                   "https://ghe.example.com/api/v3",
		"TEST_GITHUB_GHE_TOKEN":                     "ghe-token",
		"TEST_GITHUB_GHE_EL_URL":                    "https://ghe-ctrl.example.com",
		"TEST_GITHUB_GHE_REPO_OWNER_GITHUBAPP":      "ghe-org/repo",
		"TEST_GITHUB_GHE_REPO_INSTALLATION_ID":      "1",
		...
		"TEST_BITBUCKET_DATA_CENTER_API_URL":        "https://bitbucket.example.com",
